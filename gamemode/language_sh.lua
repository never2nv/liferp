...
rp_languages.english = {
	...
	-- F4menu 
	-- Tab 1
	give_money = "Use Trading Screen [F1] to give money!",
	drop_money = "Use [F1] button for safe trading!",
	change_name = "Change your ROLEPLAY name",
	advertbut = "Broadcast an advert",
	advertbox = "Input Advert Text",
	report = "Report players/staff!",
	hitbutton = "Hitmenu",
	viewhit = "View hit list",
