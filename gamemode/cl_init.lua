GM.Version = "1"
GM.Name = "LIFE RP"
GM.Author = "By Jackool/Deadman123/Derp/tgp1994/never2nv"
...
local function LoadLiquidDarkRP()
	...
	include("liquiddrp/cl_inventory.lua")
	include("liquiddrp/cl_tutorial.lua")
...
function GM:InitPostEntity()
	...
	function VoiceNotify:Paint( w, h )
		...
		print("voicevolume: "..tostring(self.ply:VoiceVolume()))
