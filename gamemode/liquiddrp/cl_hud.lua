...
function LDRP.HUDPaint()
	...
	draw.RoundedBox(6,ScrW()-42,ScrH()-42,40,40,Color(0,100,255,180))
	...
	if JustJoined then
		draw.SimpleTextOutlined( "Press F3 and click this button for settings -->","Trebuchet24", ScrW()-44, ScrH()*.98, Color(0,200,220,255), TEXT_ALIGN_RIGHT, TEXT_ALIGN_CENTER, 2, Color(40,50,240,255) )
	end
	...
	if ShowHP == 1 then
		...
		draw.RoundedBox(6,Pos1,2.7,252,22.5,Color(0,100,255,180))
		draw.RoundedBox(6,Pos1+3.6,4.95,(HPPercent*MeterW),18,Color(0,220,0,180))
		draw.SimpleTextOutlined( "Health: " .. LH, "Trebuchet18", Pos1+126, 13.95, Color(0,200,220,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(40,50,240,255) )
	end
	...
	if GetConVarNumber("cl_showammo") == 1 then
		...
		draw.RoundedBox(6,Pos3,Pos1,252,22.5,Color(0,100,255,180))
		draw.RoundedBox(6,Pos3+3.6,Pos2,MeterW,18,Color(0,200,220,180))
		local AmmoStr = (PrimaryAmmo < 0 and "Unlimited") or (PrimaryAmmo == 0 and SecondaryAmmo == 0 and "Empty") or(PrimaryAmmo .. "/" .. SecondaryAmmo)
		draw.SimpleTextOutlined( "Ammo: " .. AmmoStr, "Trebuchet18", Pos3+126, Pos4, Color(0,200,220,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(40,50,240,255) )
	end
	
	if ShowPC == 1 then
		draw.RoundedBox(6,4.32,2.7,155.52,63+CurHeight,Color(0,100,255,180))
		draw.RoundedBox(6,10.08,6.3,144,55.8+CurHeight,Color(0,200,220,180))
		local name = LP:GetName()
		if string.len(name) > 12 then name = string.sub(name,1,12) end
		
		draw.SimpleTextOutlined( name, "Trebuchet24",  82.08, 16.08, Color(0,200,220,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 2, Color(40,50,240,255) )
		
		draw.RoundedBox(6,10.08,28.8,144,35.1+CurHeight,Color(0,0,200,50))
...
LDRP.BlockHUD = {"CHudHealth", "CHudBattery", "CHudAmmo", "CHudSecondaryAmmo", "CHudChat"}
