...
LDRP.AddNPC("Reception","models/player/elispolice/police.mdl",nil,"Hello citizen, how may I help you?.",
{
	["I'd like to request a meeting with the Mayor, please!"] = function() LocalPlayer():ChatPrint("Your request to meet witht he Mayor has been sent!") end
})
