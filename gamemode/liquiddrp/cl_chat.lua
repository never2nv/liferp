...
local DoShit = function()
	...
	hook.Add("StartChat", "PChat.HideChat", HideChat)
...
local function AddToChat(msg)
	...
	--print("AddToChat [name: "..name.."] [ply: "..tostring(ply).."] [text: "..text.."]")
	if text and text ~= "" then
		--print("AddToChat STAGE 1")
		if IsValid(ply) then
...
--Hide base chatbox (???)
hook.Add("HUDShouldDraw", "PChat.HideBaseChatHud", function(name)
