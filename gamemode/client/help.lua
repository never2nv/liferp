...
addCategory(HELP_CATEGORY_CHATCMD, "Server Rules and Commands")
...
addLabel(HELP_CATEGORY_CHATCMD, "-=-SERVER RULES-=-")
addLabel(HELP_CATEGORY_CHATCMD, "1. NO PROP BLOCKING OR PUSHING!")
addLabel(HELP_CATEGORY_CHATCMD, "2. NO RANDOM DEATHMATCHING!")
...
addLabel(HELP_CATEGORY_CHATCMD, "/pm <Name/Partial Name> <Message> - Send another player a PM.")
