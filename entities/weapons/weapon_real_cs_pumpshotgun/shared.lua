...
SWEP.Instructions 		= "Buckshot Damage (Per buckshot lead): 5% \nSlug Damage (Per slug): 30% \nRecoil: 50% \nBuckshot Precision: 55% \nSlug Precision: 85% \nType: Pump-Action \n\nChange Mode: E + Right Click"
...
-- 	bullet.Callback	= function ( a, b, c ) BulletPenetration( 0, a, b, c ) end 	-- CALL THE FUNCTION BULLETPENETRATION
	...
	timer.Simple( self.EjectDelay, function()
		if not IsValid(self.Owner) or not IsFirstTimePredicted() then 
			return
		end
